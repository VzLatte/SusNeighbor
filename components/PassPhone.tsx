...
const PassPhone: React.FC<PassPhoneProps> = ({ nextPlayer, onConfirm, soundEnabled }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center space-y-12 animate-in fade-in duration-300">
      ...
      <button 
        onClick={onConfirm}
        className="w-full py-6 bg-indigo-600 hover:bg-indigo-700 text-white rounded-3xl font-black text-2xl shadow-xl shadow-indigo-500/20 active:scale-95 transition-transform border-b-4 border-indigo-900"
      >
